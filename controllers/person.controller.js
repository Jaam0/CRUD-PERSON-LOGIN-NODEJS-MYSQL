...
exports.showById = async(req, res) =>{
    ...
    res.status(200).render('person.edit',{rows:person[0]});
};

exports.save = async(req,res) =>{
    const p_type_procedure = process.env.TYPE_PROCEDURE_I;
    const id = 0;
    const {first_name,last_name,gender,age,nationatily,status} = req.body;
    ...
    res.status(201).redirect('person/index',{msg:'Person saved successfully'});
};
...
exports.update = async(req,res) =>{
    ...
    res.status(201).redirect('person/index',{msg:'Person updated successfully'});
};
...
exports.drop = async(req,res) =>{
    ...
    res.status(200).redirect('person/index',{msg:'Person deleted successfully'});
};